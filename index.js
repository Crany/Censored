...
client.on('message',  message => {
    ...
    if (!message.content.startsWith(prefix) || message.author.bot) {
        if (message.mentions.members.first().roles.cache.has(AdminRole) || message.mentions.members.first().roles.cache.has(ModsRoles) || message.mentions.members.first().roles.cache.has(AdminPerm)) {
